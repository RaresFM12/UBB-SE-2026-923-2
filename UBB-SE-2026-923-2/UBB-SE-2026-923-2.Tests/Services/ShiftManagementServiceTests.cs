...
namespace UBB_SE_2026_923_2.Tests.Services
{
    ...
    {
        private Mock<IShiftManagementStaffRepository> mockStaffRepo;
        ...
        public void Setup()
        {
            mockStaffRepo = new Mock<IShiftManagementStaffRepository>();
            mockShiftRepo = new Mock<IShiftManagementShiftRepository>();
            service = new ShiftManagementService(mockStaffRepo.Object, mockShiftRepo.Object);
        ...
        public void SetShiftActive_ExistingShift_UpdatesStatus()
        {
            ...
            mockShiftRepo.Verify(r => r.UpdateShiftStatus(1, ShiftStatus.ACTIVE), Times.Once);
            mockStaffRepo.Verify(r => r.UpdateStaffAvailability(1, true, DoctorStatus.AVAILABLE), Times.Once);
        }
        ...
        public void SetShiftActive_NonExistingShift_DoesNothing()
        {
            ...
            mockShiftRepo.Verify(r => r.UpdateShiftStatus(It.IsAny<int>(), It.IsAny<ShiftStatus>()), Times.Never);
        }
        ...
        public void CancelShift_ExistingActiveShift_CancelsAndUpdatesAvailability()
        {
            ...
            mockShiftRepo.Verify(r => r.UpdateShiftStatus(1, ShiftStatus.CANCELLED), Times.Once);
            mockStaffRepo.Verify(r => r.UpdateStaffAvailability(1, false, DoctorStatus.OFF_DUTY), Times.Once);
        }
        ...
        public void CancelShift_ExistingScheduledShift_CancelsNoAvailabilityUpdate()
        {
            ...
            service.CancelShift(1);
            mockShiftRepo.Verify(r => r.UpdateShiftStatus(1, ShiftStatus.CANCELLED), Times.Once);
            mockStaffRepo.Verify(r => r.UpdateStaffAvailability(It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<DoctorStatus>()), Times.Never);
        }
        ...
        public void TryAddShift_NoOverlap_AddsAndReturnsTrue()
        {
            ...
            mockShiftRepo.Verify(r => r.AddShift(It.IsAny<Shift>()), Times.Once);
        }
        ...
        public void TryAddShift_Overlap_ReturnsFalse()
        {
            ...
            mockShiftRepo.Verify(r => r.AddShift(It.IsAny<Shift>()), Times.Never);
        }
        ...
        public void ReassignShift_OverlapForNewStaff_ReturnsFalse()
        {
            ...
            mockShiftRepo.Setup(r => r.GetAllShifts()).Returns(new List<Shift> { shift, existingShift });
        ...
        public void FindStaffReplacements_ReturnsOnlySameType()
        {
            ...
            var shift = new Shift(1, doctor1, "Ward A", now, now.AddHours(8), ShiftStatus.SCHEDULED);
            mockShiftRepo.Setup(r => r.GetAllShifts()).Returns(new List<Shift> { shift });
            mockStaffRepo.Setup(r => r.LoadAllStaff()).Returns(new List<IStaff> { doctor1, doctor2, pharmacist1 });
        ...
        {
            mockStaffRepo.Setup(r => r.LoadAllStaff()).Returns(new List<IStaff> { doctor1, pharmacist1 });
