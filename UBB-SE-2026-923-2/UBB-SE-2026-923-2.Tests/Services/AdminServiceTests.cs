namespace UBB_SE_2026_923_2.Tests.Services
{
    ...
    public class AdminServiceTests
    {
        ...
        public void GetAllItems_ReturnsItemsFromRepository()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(items);
        ...
        public void GetAllSubstances_ReturnsSubstancesFromRepository()
        {
            ...
            this.mockSubstanceRepo.Setup(r => r.GetAllSubstances()).Returns(substances);
        ...
        public void GetItemById_ReturnsFromRepository()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetItemById(1)).Returns(item);
        ...
        public void GetSubstanceByName_ReturnsFromRepository()
        {
            ...
            this.mockSubstanceRepo.Setup(r => r.GetSubstanceByName("Ibuprofen")).Returns(substance);
        ...
        {
            this.mockSubstanceRepo.Setup(r => r.SubstanceExists("Ibuprofen")).Returns(true);
        ...
        {
            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(new List<Item>());
            ...
            this.mockItemRepo.Verify(r => r.AddItemWithQuantity(
        ...
        public void RemoveItemById_CallsRepository()
        {
            ...
            this.mockItemRepo.Verify(r => r.RemoveItemById(1), Times.Once);
        }
        ...
        public void UpdateItemById_ItemExists_UpdatesItem()
        {
            ...
            this.mockItemRepo.Setup(r => r.ItemExists(1)).Returns(true);
            this.mockItemRepo.Setup(r => r.GetItemById(1)).Returns(existingItem);

            this.service.UpdateItemById(1, updatedItem);

            Assert.That(updatedItem.Id, Is.EqualTo(1));
            this.mockItemRepo.Verify(r => r.UpdateItemById(updatedItem), Times.Once);
        }

        [Test]
        public void UpdateItemById_ItemDoesNotExist_ThrowsArgumentException()
        {
            this.mockItemRepo.Setup(r => r.ItemExists(1)).Returns(false);
        ...
        {
            this.mockSubstanceRepo.Setup(r => r.SubstanceExists("New")).Returns(false);
            var substance = new Substance("New", 100f, "Desc");

            this.service.AddSubstance(substance);

            this.mockSubstanceRepo.Verify(r => r.AddSubstance("New", 100f, "Desc"), Times.Once);
        }

        [Test]
        public void AddSubstance_Duplicate_ThrowsArgumentException()
        {
            this.mockSubstanceRepo.Setup(r => r.SubstanceExists("Existing")).Returns(true);
        ...
        {
            this.mockSubstanceRepo.Setup(r => r.SubstanceExists("Sub")).Returns(true);
            var substance = new Substance("Sub", 100f, "Desc");

            this.service.RemoveSubstanceByName(substance);

            this.mockSubstanceRepo.Verify(r => r.RemoveSubstanceByName("Sub"), Times.Once);
        }

        [Test]
        public void RemoveSubstanceByName_NotExists_ThrowsArgumentException()
        {
            this.mockSubstanceRepo.Setup(r => r.SubstanceExists("None")).Returns(false);
        ...
        public void UpdateSubstanceByName_Exists_CallsRepository()
        {
            ...
            this.mockSubstanceRepo.Verify(r => r.UpdateSubstanceByName(substance), Times.Once);
        }
        ...
        public void ValidateItemForAdd_DuplicateName_ThrowsArgumentException()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(new List<Item> { existingItem });
        ...
        public void GetExpiredItems_ExpiredBatch_ReturnsItem()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(new List<Item> { expiredItem });
        ...
        public void GetExpiredItems_NoBatchesExpired_ReturnsEmpty()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(new List<Item> { freshItem });
        ...
        public void GetNotificationsForUser_AdminWithExpiredBatch_ReturnsNotification()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(new List<Item> { item });
        ...
        public void GetNotificationsForUser_ClientWithStockAlert_ReturnsNotification()
        {
            ...
            var item = new Item { Id = 1, Name = "Aspirin", Producer = "Bayer", Category = "Pain", Price = 10f, NumberOfPills = 20 , Quantity = 5 };
            item.ActiveSubstances = new Dictionary<string, float> { { "ASA", 500f } };            this.mockItemRepo.Setup(r => r.GetAllItems()).Returns(new List<Item>());
            this.mockItemRepo.Setup(r => r.GetItemById(1)).Returns(item);

            var result = this.service.GetNotificationsForUser(user);

            Assert.That(result.Count, Is.EqualTo(1));
            Assert.That(result[0].Title, Is.EqualTo("Stock Alert"));
        }
        ...
        public void GetTop30Items_DelegatesToRepository()
        {
            ...
            this.mockItemRepo.Setup(r => r.GetTop30Items()).Returns(top30);
        ...
        public void GetTop30Substances_DelegatesToRepository()
        {
            ...
            this.mockSubstanceRepo.Setup(r => r.GetTop30Substances()).Returns(top30);
