...
BEGIN
    CREATE TABLE dbo.Users (
        ...
        [role]                  NVARCHAR(20)    NOT NULL CONSTRAINT DF_Users_Role       DEFAULT (N'Client'),
...
-- Users (with role column: Admin, Client, Doctor, Pharmacist)
IF NOT EXISTS (SELECT 1 FROM dbo.Users)
BEGIN
    INSERT INTO dbo.Users (email, phoneNumber, passwordHash, isDisabled, isAdmin, username, [role], discountNotifications, loyaltyPoints) VALUES
        (N'admin@pharmacy.local', N'0700000000', N'hashed_pwd_admin', 0, 1, N'admin_super',  N'Admin',      1, 1000),
        (N'johndoe@test.com',     N'0711111111', N'hashed_pwd_john',  0, 0, N'johndoe',      N'Client',     1,  150),
        (N'janedoe@test.com',     N'0722222222', N'hashed_pwd_jane',  0, 0, N'janedoe',      N'Client',     0,   45),
        (N'house@hospital.local', N'0733333333', N'hashed_pwd_house', 0, 0, N'dr_house',     N'Doctor',     0,    0),
        (N'jamie@hospital.local', N'0744444444', N'hashed_pwd_jamie', 0, 0, N'jamie_pharm',  N'Pharmacist', 0,    0);
END
GO
